...
for i in range(50):
    ...
    bloque = Bloque(NEGRO, 20, 15,"z.png")
...
protagonista = Protagonista(ROJO, 20, 15,"we.png")
...
while not hecho:
    ...
    fondo=pygame.image.load("callee.png")
    ...
    scoretext=myfont.render("Marcador ="+str(puntuacion), 1, BLANCO)
